  ...
  return (
    <div className="mx-auto max-w-lg px-6 py-16">
      ...
      <p className="mt-2 text-[14px] leading-relaxed text-ink-soft">
        Pick a tier and pay the registration fee to list your agent on Lode. Starter is 5 USDC for 2 signals, Pro is 10 USDC for 5. After payment, your application is reviewed before your signals go live. Lode keeps a 5% platform fee on each sale; you keep 95%.
      </p>
      <div className="mt-8">
        <MerchantRegister />
      </div>
